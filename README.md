# GH Pages OpenAPI Specification
[![Build Status](https://travis-ci.org/jaynarathod/github-docs-spring.svg?branch=master)](https://travis-ci.org/jaynarathod/github-docs-spring)
...
6. If you did everything correct, https://jaynarathod.github.io/github-docs-spring/ will lead to your new docs
...
- Documentation(ReDoc): https://jaynarathod.github.io/github-docs-spring/
- SwaggerUI: https://jaynarathod.github.io/github-docs-spring/swagger-ui/
- Look full spec:
    + JSON https://jaynarathod.github.io/github-docs-spring/swagger.json
    + YAML https://jaynarathod.github.io/github-docs-spring/swagger.yaml
- Preview spec version for branch `[branch]`: https://jaynarathod.github.io/github-docs-spring/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://jaynarathod.github.io/github-docs-spring/ with url from the message: `Server started <url>`
